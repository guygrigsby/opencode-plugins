---
description: Critical reviewer for sno plan phase. Performs adversarial review of the draft plan — checking for gaps, inconsistencies, missed risks, and spec drift. Runs after all other plan agents complete.
mode: subagent
